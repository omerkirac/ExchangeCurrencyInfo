    ...
    $.fn.extend({
        ...
        jClocksGMT: function (options) {
            ...
            return this.each(function () {
                ...
                if (options.analog) {
                    ...
                    function SetSkins() {
                        if (createdClocks < 6) {
                            ...
                            var convertedTime = timeStringToFloat(this.timeStr);
                            ...
                            $("<div />", {
                                ...
                                class: "jcgmt-hour",
                                src: options.imgpath + "images/jcgmt-" + options.skin + "-clock_hour.png"
                            })).appendTo("#" + id + ' .jcgmt-clockHolder');
                            // create min hand
                            $("<div />", {
                                class: "jcgmt-rotatingWrapper"
                            }).append($("<img />", {
                                class: "jcgmt-min",
                                src: options.imgpath + "images/jcgmt-" + options.skin + "-clock_min.png"
                            })).appendTo("#" + id + ' .jcgmt-clockHolder');
                            // create sec hand
                            $("<div />", {
                                class: "jcgmt-rotatingWrapper"
                                ...
                                class: "jcgmt-sec",
                                src: options.imgpath + "images/jcgmt-" + options.skin + "-clock_sec.png"
                            })).appendTo("#" + id + ' .jcgmt-clockHolder');
                            // create clock face
                            $("<img />", {
                                class: "jcgmt-clock",
                                src: options.imgpath + 'images/jcgmt-' + options.skin + '-clock_face.png'
                            }).appendTo("#" + id + ' .jcgmt-clockHolder');
                            createdClocks++;
                        }
                    }
                ...
                //     return timeStringToFloat(sHours + ":" + sMinutes)
                // }
                ...
                function clockInterval() {
                    ...
                    this.timeStr = nd.format(options.timeformat);
                    ...
                    SetSkins();
                    // var suns = options.sunset.format('HH:mm');
                    // var sunr = options.sunrise.format('HH:mm');
                    // var denemesunr = sunr.format('HH:mm')
                    // var sunsetTime = timeStringToFloat(options.sunset);
                    // var sunriseTime = timeStringToFloat(options.sunrise);
                    // var convertedTime = timeStringToFloat(this.timeStr);
